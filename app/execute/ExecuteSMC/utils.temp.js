...
//     const trending = forecastTrending(candleStickData);
...
//       case "go-down": {
//         if (true && checkFullCandle(lastestCandle, "down")) {
//           const maxRange50 = getMaxOnListCandle(candleStickData.slice(-50), 2);
//           const minRange50 = getMinOnListCandle(candleStickData.slice(-50), 3);
  
//           if (maxRange50 * 0.985 < lastestCandle[2]) {
//             const EstRR = (maxRange50 / lastestCandle[4] - 1) * 100 * 1.05;
...
//               .slice(-25)
//               .every((candle) =>
//                 isDownCandle(candle) ? candle[1] / candle[4] < 1.03 : true
//               );
//             if (
//               CONDITION_1__ &&
//               CONDITION_2__ &&
...
//         if (checkFullCandle(lastestCandle, "up")) {
//           const EstRR = (lastestCandle[4] / minRange50 - 1) * 100 * 1.05;
...
//             timeStamp = lastestCandle[0];
//           }
//         } else if (isDownCandle(lastestCandle)) {
//           const EstRR = (maxRange50 / lastestCandle[4] - 1) * 100 * 1.05;
