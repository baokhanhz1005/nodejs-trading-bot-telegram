...
const checkPattern = (candleStickData, symbol) => {
    ...
    if (lastMacd > lastSignal) {
        ...
        } else if (true && (checkFullCandle(lastestCandle, "up") || checkPinbar(lastestCandle, "up")) && maxRange45 * 1.004 < lastestCandle[4]) {
        ...
        } else if (true && isDownCandle(lastestCandle) && minRange45 * 0.996 > lastestCandle[4]) {
